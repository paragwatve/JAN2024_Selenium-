...
public class CaseStudy2_TestNG {
	WebDriver driver;
	  @Test(dataProvider = "dp")
	  public void f(String fname, String lname) throws Exception {
		  driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		  CaseStudy1_1TestNGPOM obj = new CaseStudy1_1TestNGPOM(driver);
		  ...
		  if(obj.checkitem()) {
			  ...
			  File dfile4 = new File("C:\\Users\\parag.watve\\eclipse-workspace\\JAN2024_Selenium\\verifylogin.png");
	  ...
	  public Object[][] dp() throws Exception {
		  File f1 = new File("C:\\Users\\parag.watve\\eclipse-workspace\\JAN2024_Selenium\\Lumalogin.xlsx");
